...
const Register = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-blue-200 to-purple-300">
            ...
            >
                <h2 className="text-4xl font-bold text-center text-gray-700">Let's get to know you !</h2>
                ...
                <label className="text-gray-700 font-medium text-lg">Pick Your Spirit Animal:</label>
                    ...
                    {spiritAnimals.map((animal) => (
                        <button
                            ...
                            className={`p-3 text-2xl border rounded-md transition-all ${
                                spiritAnimal === animal ? "bg-blue-400 text-white scale-110" : "bg-gray-200"
                            }`}
